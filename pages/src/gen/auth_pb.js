...
goog.exportSymbol('proto.discord.DiscordGuild', null, global);
 ...
 * @constructor
 */
proto.discord.DiscordGuild = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.discord.DiscordGuild, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.discord.DiscordGuild.displayName = 'proto.discord.DiscordGuild';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.discord.ValidateGuildIdResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    guildInfo: (f = msg.getGuildInfo()) && proto.discord.DiscordGuild.toObject(includeInstance, f)
  };
...
proto.discord.ValidateGuildIdResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 2:
      var value = new proto.discord.DiscordGuild;
      reader.readMessage(value,proto.discord.DiscordGuild.deserializeBinaryFromReader);
...
proto.discord.ValidateGuildIdResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.discord.DiscordGuild.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional DiscordGuild guild_info = 2;
 * @return {?proto.discord.DiscordGuild}
 */
proto.discord.ValidateGuildIdResponse.prototype.getGuildInfo = function() {
  return /** @type{?proto.discord.DiscordGuild} */ (
    jspb.Message.getWrapperField(this, proto.discord.DiscordGuild, 2));
};


/**
 * @param {?proto.discord.DiscordGuild|undefined} value
 * @return {!proto.discord.ValidateGuildIdResponse} returns this
*/
proto.discord.ValidateGuildIdResponse.prototype.setGuildInfo = function(value) {
 ...
 * @return {!proto.discord.ValidateGuildIdResponse} returns this
 */
proto.discord.ValidateGuildIdResponse.prototype.clearGuildInfo = function() {
 ...
 * @return {boolean}
 */
proto.discord.ValidateGuildIdResponse.prototype.hasGuildInfo = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.discord.DiscordGuild.prototype.toObject = function(opt_includeInstance) {
  return proto.discord.DiscordGuild.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.discord.DiscordGuild} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.discord.DiscordGuild.toObject = function(includeInstance, msg) {
  var f, obj = {
    guildId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * @return {!proto.discord.DiscordGuild}
 */
proto.discord.DiscordGuild.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.discord.DiscordGuild;
  return proto.discord.DiscordGuild.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.discord.DiscordGuild} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.discord.DiscordGuild}
 */
proto.discord.DiscordGuild.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.discord.DiscordGuild.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.discord.DiscordGuild.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.discord.DiscordGuild} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.discord.DiscordGuild.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGuildId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.discord.DiscordGuild.prototype.getGuildId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.discord.DiscordGuild} returns this
 */
proto.discord.DiscordGuild.prototype.setGuildId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.discord.DiscordGuild.prototype.getGuildName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.discord.DiscordGuild} returns this
 */
proto.discord.DiscordGuild.prototype.setGuildName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.discord.DiscordGuild.prototype.getIcon = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.discord.DiscordGuild} returns this
 */
proto.discord.DiscordGuild.prototype.setIcon = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
